...
public class BookController {
    ...
    @ApiResponses({
            @ApiResponse(code = 204, message = "No Content - Book succesfully deleted"),
            @ApiResponse(code = 401, message = "Unauthorized - Not authorized"),
            @ApiResponse(code = 403, message = "Forbidden - Proibido")
    })
